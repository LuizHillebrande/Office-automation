...
for indice, linha in enumerate(sheet_honorarios.iter_rows(min_row=2,max_row=95)):
    ...
    image = Image.open('./honorario_fim_de_ano.jpg')
    ...
    desenhar.text((780,627),str(primeira_parcela_13),font= fonte_menor, fill='black')
